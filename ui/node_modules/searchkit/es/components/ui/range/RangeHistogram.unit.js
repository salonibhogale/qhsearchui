...
describe('RangeHistogram', () => {
    it('should render and behave correctly', () => {
        this.wrapper = mount(React.createElement(MockRange, { rangeComponent: RangeHistogram }));
        expect(this.wrapper).toMatchSnapshot();
    });
    it('mod + classname can be updated', () => {
        this.wrapper = mount(React.createElement(MockRange, { rangeComponent: RangeHistogram, mod: "sk-range-histogram-updated", className: "my-custom-class" }));
