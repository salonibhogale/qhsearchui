...
describe('ItemHistogramList Components', () => {
    it('should render and behave correctly', () => {
        this.wrapper = mount(React.createElement(MockList, { listComponent: ItemHistogramList }));
    ...
    it('should handle multiselect={false}', () => {
        this.wrapper = mount(React.createElement(MockList, { listComponent: ItemHistogramList, multiselect: false }));
        expect(this.wrapper.instance().state.toggleItem).not.toHaveBeenCalled();
    ...
    it('mod + classname can be updated', () => {
        this.wrapper = mount(React.createElement(MockList, { listComponent: ItemHistogramList, mod: "sk-item-list-updated", className: "my-custom-class" }));
