...
describe('Facet Filter tests', () => {
    ...
    beforeEach(() => {
        ...
        this.mountComponent = () => {
            this.createWrapper(React.createElement(FacetFilter, { field: "test", id: "testId", title: "test title", size: 3, countFormatter: (count) => '#' + count, include: "title", exclude: ['bad', 'n/a'], operator: "OR", orderKey: "_count", orderDirection: "desc", translations: { 'facets.view_all': 'View all facets' }, searchkit: this.searchkit, bucketsTransform: _.identity }));
        };
        this.mountComponent();
    ...
    it('should work with a custom itemComponent', () => {
        this.createWrapper(React.createElement(FacetFilter, { itemComponent: ({ label, count }) => (React.createElement("div", { className: "option" },
                label,
                " (",
                count,
                ")")), field: "test", id: "testId", title: "test title", searchkit: this.searchkit }));
    ...
    it('should work with custom components', () => {
        const container = (props) => React.createElement("div", Object.assign({}, props), props.children);
        this.createWrapper(React.createElement(RefinementListFilter, { containerComponent: container, listComponent: Toggle, itemComponent: (props) => React.createElement(ItemComponent, Object.assign({}, props, { showCount: true })), field: "test", id: "testId", title: "test title", bucketsTransform: (buckets) => _.reverse(buckets), searchkit: this.searchkit }));
        expect(this.wrapper).toMatchSnapshot();
    });
});
