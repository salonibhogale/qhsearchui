...
describe('Dynamic Range Filter tests', () => {
    beforeEach(() => {
        ...
        this.createWrapper = () => {
            this.wrapper = mount(React.createElement(DynamicRangeFilter, { id: "m", searchkit: this.searchkit, field: "metascore", title: "metascore", rangeFormatter: this.rangeFormatter, translations: { 'range.divider': ' TO ' } }));
