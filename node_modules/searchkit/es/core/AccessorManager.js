...
export class AccessorManager {
    ...
    getState() {
        return reduce(this.getStatefulAccessors(), (state, accessor) => assign(state, accessor.getQueryObject()), {});
    }
    setState(state) {
    ...
    buildSharedQuery(query) {
        return reduce(this.getActiveAccessors(), (query, accessor) => accessor.buildSharedQuery(query), query);
    }
    buildOwnQuery(query) {
        return reduce(this.getActiveAccessors(), (query, accessor) => accessor.buildOwnQuery(query), query);
    }
    buildQuery() {
