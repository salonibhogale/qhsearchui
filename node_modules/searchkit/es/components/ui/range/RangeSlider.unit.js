...
describe('RangeSlider', () => {
    it('should render and behave correctly', () => {
        this.wrapper = mount(React.createElement(MockRange, { rangeComponent: RangeSlider }));
        expect(this.wrapper).toMatchSnapshot();
    });
    it('mod + classname can be updated', () => {
        this.wrapper = mount(React.createElement(MockRange, { rangeComponent: RangeSlider, mod: "sk-range-slider-updated", className: "my-custom-class" }));
