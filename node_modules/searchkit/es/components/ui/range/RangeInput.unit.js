...
describe('RangeInput', () => {
    it('should render and behave correctly', () => {
        this.wrapper = mount(React.createElement(MockRange, { rangeComponent: RangeInput }));
        expect(this.wrapper).toMatchSnapshot();
    });
    it('mod + classname can be updated', () => {
        this.wrapper = mount(React.createElement(MockRange, { rangeComponent: RangeInput, mod: "sk-range-slider-updated", className: "my-custom-class" }));
