...
describe('ItemList Components', () => {
    it('ItemList should render and behave correctly', () => {
        this.wrapper = mount(React.createElement(MockList, { listComponent: ItemList }));
    ...
    it('mod + classname can be updated', () => {
        this.wrapper = mount(React.createElement(MockList, { listComponent: ItemList, mod: "sk-item-list-updated", className: "my-custom-class" }));
