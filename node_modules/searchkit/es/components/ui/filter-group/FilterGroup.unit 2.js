...
describe('FilterGroup', () => {
    beforeEach(() => {
        ...
        this.filters = [{ value: 'A' }, { value: 'B' }, { value: 'C' }, { value: 'D' }];
    });
    it('should render and behave correctly', () => {
        this.wrapper = mount(React.createElement(FilterGroup, { title: this.title, translate: this.translate, className: "filter-group-1", removeFilter: this.removeFilter, removeFilters: this.removeFilters, filters: this.filters }));
    ...
    it('mod + classname can be updated', () => {
        this.wrapper = mount(React.createElement(FilterGroup, { mod: "sk-filter-group-updated", className: "my-custom-class", title: this.title, translate: this.translate, removeFilter: this.removeFilter, removeFilters: this.removeFilters, filters: this.filters }));
