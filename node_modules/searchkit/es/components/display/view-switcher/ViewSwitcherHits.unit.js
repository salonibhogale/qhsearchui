...
const MovieHitsGridItem = (props) => React.createElement("div", { className: "grid-item" }, props.result.title);
const MovieHitsListItem = (props) => React.createElement("div", { className: "list-item" }, props.result.title);
const MovieList = (props) => React.createElement("div", { className: "custom-list" }, _.map(props.hits, '_id').join(','));
