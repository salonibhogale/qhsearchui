...
describe('CheckboxFilter tests', () => {
    ...
    beforeEach(() => {
        ...
        this.createWrapper(React.createElement(CheckboxFilter, { id: "test id", title: "test title", label: "test label", searchkit: this.searchkit, filter: TermQuery('test-field', 'test-value') }));
    });
