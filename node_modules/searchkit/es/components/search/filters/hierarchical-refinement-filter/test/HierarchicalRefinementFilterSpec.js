...
describe('Refinement List Filter tests', () => {
    beforeEach(() => {
        ...
        this.mount = () => {
            this.wrapper = mount(React.createElement(HierarchicalRefinementFilter, { countFormatter: (count) => '#' + count, field: "test", id: "testid", title: "test title", searchkit: this.searchkit }));
        };
        this.mount();
