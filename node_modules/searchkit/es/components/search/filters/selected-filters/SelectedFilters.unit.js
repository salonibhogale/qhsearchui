...
describe('SelectedFilters tests', () => {
    beforeEach(() => {
        ...
        this.createWrapper = (props) => {
            this.wrapper = mount(React.createElement(SelectedFilters, Object.assign({ searchkit: this.searchkit }, props)));
        };
    ...
    it('overrides', () => {
        const FilterItem = (props) => (React.createElement("div", { className: props.bemBlocks.option() },
